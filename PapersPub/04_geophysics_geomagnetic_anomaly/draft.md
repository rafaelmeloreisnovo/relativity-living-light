# Geofísica: Anomalias Geomagnéticas

**Status:** `planned`  
**Escopo:** Geomagnetic anomaly paper track, starting with documented South Atlantic Magnetic Anomaly cases.
...
- `docs/observational_records/2026-05-29_INPE_GRAVITACAO_COSMOLOGIA_REGISTRO.md`
- `docs/DATA_INTEGRITY_CHECKLIST.md`
- `newadd/02_PHYSICS.md`
