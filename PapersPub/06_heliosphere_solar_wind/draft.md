# Heliosfera: Vento Solar e Plasma

**Status:** `planned`  
**Escopo:** Solar-wind/plasma heliosphere validation track, separated from cosmological claims.
...
- `docs/ARQUITETURA_DUAS_RADIACOES_IMPLEMENTACAO.md`
