...
def main():
    print("=" * 65)
    print("  RLL FASE 18-C (Corrigido) — r_s(z_*) + Prior BBN")
    print("  5 datasets · 6 parâmetros · rd numérico · profile 10×10")
    print("=" * 65)
    ...
    out = {
        "metadata": {
            "fase": "FASE 18-C",
            "correcoes": ["rs_star_para_lA_CMB", "rd_numerico_BAO", "prior_bbn", "starts_bbn_ancorados"],
            "status_epistemico": "[E] análise corrigida — r_s(z_*) para CMB, r_s(z_drag) para BAO",
            "n_total": n_total
        },
        "verificacao_planck": {
    ...
    out_path = RESULTS / "rll_fase18c_corrigido.json"
