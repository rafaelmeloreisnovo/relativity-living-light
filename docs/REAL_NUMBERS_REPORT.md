...
Gerado em: `2026-06-13T08:25:59.034875+00:00`  
Commit: `3e303b04fed120e097067ca5c6b0848436cf3e75`

| Métrica | Valor |
|---|---:|
| `tracked_files_total` | 863 |
| `cataloged_files` | 845 |
| `uncataloged_or_error_files` | 18 |
| `total_bytes` | 34871814 |
| `total_text_lines` | 131410 |
| `markdown_files` | 430 |
| `yml_yaml_files` | 51 |
| `github_workflow_yml_files` | 18 |
| `data_or_result_files` | 96 |

## Categorias

| Categoria | Arquivos |
|---|---:|
| `documentation_md` | 430 |
| `source_code` | 132 |
| `other` | 129 |
| `data_or_result` | 96 |
| `config_yml` | 33 |
