...
Gerado em: `2026-06-13T04:51:46.867821+00:00`  
Commit: `0cdaa053f4384b266c0920555e29d472b3195418`

| Métrica | Valor |
|---|---:|
| `tracked_files_total` | 807 |
| `cataloged_files` | 789 |
| `uncataloged_or_error_files` | 18 |
| `total_bytes` | 34528601 |
| `total_text_lines` | 123535 |
| `markdown_files` | 412 |
| `yml_yaml_files` | 34 |
...
| Flag | Ocorrências |
|---|---:|
| `cosmology_validation_marker` | 379 |
| `mentions_mock_or_placeholder` | 73 |
| `result_artifact` | 73 |
