...
Gerado em: `2026-06-08T04:26:03.552926+00:00`  
Commit: `e0e7670d7deb263b892d0bdb079c86f846de1a11`

| Métrica | Valor |
|---|---:|
| `tracked_files_total` | 762 |
| `cataloged_files` | 744 |
| `uncataloged_or_error_files` | 18 |
| `total_bytes` | 34018559 |
| `total_text_lines` | 118303 |
| `markdown_files` | 387 |
| `yml_yaml_files` | 32 |
