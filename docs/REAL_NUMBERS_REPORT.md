...
Gerado em: `2026-06-08T02:59:38.007969+00:00`  
Commit: `43a668905b7ced3b54083cb00144227976bedc58`

| Métrica | Valor |
|---|---:|
| `tracked_files_total` | 754 |
| `cataloged_files` | 736 |
| `uncataloged_or_error_files` | 18 |
| `total_bytes` | 34011442 |
| `total_text_lines` | 118098 |
| `markdown_files` | 379 |
| `yml_yaml_files` | 32 |
...
| Flag | Ocorrências |
|---|---:|
| `cosmology_validation_marker` | 346 |
| `mentions_mock_or_placeholder` | 68 |
| `result_artifact` | 62 |
| `mentions_synthetic` | 57 |
| `token_vazio_declared` | 13 |
