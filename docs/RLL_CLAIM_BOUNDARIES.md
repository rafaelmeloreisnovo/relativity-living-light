# RLL Claim Boundaries and Validation Discipline

## Princípios de fronteira de claim
...
1. **Resposta ao impulso e modos normais**: descrevem dinâmica de meio; exigem ajuste quantitativo e repetibilidade.
2. **Tidal triggering**: efeito estatístico contextual; não é previsão determinística universal de terremotos.
3. **Caos/Lyapunov**: demonstra sensibilidade dinâmica; não estabelece sozinho novo modelo cosmológico.
