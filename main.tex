...
\begin{figure}[h!]
\centering
\includegraphics[width=\linewidth]{figs/paper/fig_pipeline.png}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.78\linewidth]{figs/paper/fig_quadratic.png}
\caption{Local quadratic (Bh\'askara) model for the mean field $\Phi(z)$; the vertex indicates a stable/transition epoch.}
\end{figure}

\begin{figure}[h!]
\centering
\includegraphics[width=0.90\linewidth]{figs/paper/fig_degeneracy.png}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.70\linewidth]{figs/paper/fig_kappa_field.png}
